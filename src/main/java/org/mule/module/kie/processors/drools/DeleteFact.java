...
public class DeleteFact extends AbstractFactMessageProcessor
{
    ...
    protected MessageProcessor createMessageProcessor() throws MuleException
    {
        return new MessageProcessor()
        {
            ...
            public MuleEvent process(MuleEvent event) throws MuleException
            {
                ...
                {
                    muleFact.setHandle(kieSession.getFactHandle(muleFact.getFact()));
                }
                kieSession.delete(muleFact.getHandle());
